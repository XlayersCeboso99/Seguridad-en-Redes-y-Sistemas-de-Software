...
## Solución
```
XlayersCeboso-academy@webshell:~$ wget https://artifacts.picoctf.net/c_titan/157/challenge.zip
--2026-08-30 02:35:07--  https://artifacts.picoctf.net/c_titan/157/challenge.zip
...
XlayersCeboso-academy@webshell:~/drop-in$ wget https://artifacts.picoctf.net/c_titan/157/challenge.zip
--2026-08-30 02:39:15--  https://artifacts.picoctf.net/c_titan/157/challenge.zip
...
2026-08-30 02:39:15 (1.85 MB/s) - 'challenge.zip' saved [293587/293587]

XlayersCeboso-academy@webshell:~/drop-in$ unzip challenge.zip 
...
XlayersCeboso-academy@webshell:~/drop-in$ cd drop-in/
XlayersCeboso-academy@webshell:~/drop-in/drop-in$ git log message.py
XlayersCeboso-academy@webshell:~/drop-in/drop-in$ cat message.py 
print("Hello, World!"
XlayersCeboso-academy@webshell:~/drop-in/drop-in$ git log message.py
XlayersCeboso-academy@webshell:~/drop-in/drop-in$ 
```
## Notas Adicionales
## Referencias
